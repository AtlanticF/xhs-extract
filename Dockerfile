...
ENV ENV PUPPETEER_CHROME_DOWNLOAD_BASE_URL=$PUPPETEER_CHROME_DOWNLOAD_BASE_URL \
    PUPPETEER_CHROME_HEADLESS_DOWNLOAD_BASE_URL=$PUPPETEER_CHROME_DOWNLOAD_VERSION \
# 设置 npm 源为阿里云
RUN npm config set registry https://registry.npmmirror.com/

RUN npm install

CMD ["node", "parse_xhs.js"]